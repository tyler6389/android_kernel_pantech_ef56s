...
//----------------------------------------------------------------------------------
// 20110929, albatros, partition sizeÍ∞Ä Ïª§Ï†∏???ëÏùÑ ?òÎ¶∞??
// ?¨Ïù¥Ï¶àÍ? Ïª§Ï?ÎØÄÎ°??âÎÑâ?òÍ≤å 80Í∞??°Îäî??
...
// p11955 : SKT lost phone service data
#define SKT_LOST_PHONE_SERVICE_DATA_START               (SDCARD_UPDATE_RESULT_START+SDCARD_UPDATE_RESULT_LENGTH)
#define SKT_LOST_PHONE_SERVICE_DATA_LENGTH		(SECTOR_SIZE*SECTOR_SIZE_DEFAULT)
// p11955 : SKT lost phone service data

//20130610 P14787 djjeon PMIC  10% offline charging  Auto power on  FEATURE_PANTECH_PMIC_AUTO_PWR_ON
#define PANTECH_PMIC_AUTO_PWR_ON_START         (SKT_LOST_PHONE_SERVICE_DATA_START+SKT_LOST_PHONE_SERVICE_DATA_LENGTH)
...
// Backup Item Ï∂îÍ???BACKUP_SECTOR_LENGTH ?ÑÏóê Ï∂îÍ? ?òÏãúÍ≥??¥ÎÜà???òÏ†ï??Ï£ºÏÑ∏??// ?êÌïú LINUX??sky_rawdata.h(android/pantech/framworks/sky_rawdata)?êÎèÑ ?ôÏùº?òÍ≤å update ?¥Ï£º?∏Ïöî!!!
